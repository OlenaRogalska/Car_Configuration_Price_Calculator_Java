...
public class GolfCart extends Automobile implements Serializable {
...
//creates new Option object (with name and price) and adds it to array list <Option>
    ...
    public int findOptionSetNameIndex(String optSetNameToChange) {
        ...
        if (indexInOptSets == -1) {
            ...
            throw new AutoException(errorMessage, 200, this);
        }
...
//change to traverse and pick the name from arrayList
